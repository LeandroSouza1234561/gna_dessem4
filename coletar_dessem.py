...
def verificar_e_alertar(registros):
    ...
    linhas = "".join(
        f"<tr>"
        f"<td style='padding:6px 12px;border-bottom:1px solid #1e3a5f;color:{'#00c8ff' if a['planta']=='GNA I' else '#ffaa00'}'>{a['planta']}</td>"
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            for tabela in tabelas:
                ...
                SUBHEADER_KEYWORDS = {"dessem","sugerido","total","intervalo","programado","meia hora","ggna","ggna2"}
