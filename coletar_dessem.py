...
<header>
  <div class="header-left">
    ...
    <div class="header-title">
      <h1>PDO Oper Titulacao Usinas</h1>
...
<div class="meta-row" id="meta-row" style="display:none">
  <div class="meta-card"><div class="meta-label">Colunas Titulacao</div><div class="meta-value" id="meta-cols">-</div></div>
  <div class="meta-card"><div class="meta-label">GNA I (Titulacao)</div><div class="meta-value" style="color:var(--gna1)" id="meta-gna1">-</div></div>
  <div class="meta-card"><div class="meta-label">GNA II (Titulacao)</div><div class="meta-value" style="color:var(--gna2)" id="meta-gna2">-</div></div>
...
<div class="panel" id="tab-gna1">
  <div class="panel-header">
    ...
    <span class="panel-title">GNA I - Titulacao</span>
  ...
  <div class="table-wrap"><table><thead id="thead-gna1"><tr><th>-</th></tr></thead><tbody id="tbody-gna1"></tbody></table></div>
</div>
<div class="panel" id="tab-gna2" style="display:none">
  <div class="panel-header">
    <div class="panel-accent c2"></div>
    <span class="panel-title">GNA II - Titulacao</span>
  ...
  <div class="table-wrap"><table><thead id="thead-gna2"><tr><th>-</th></tr></thead><tbody id="tbody-gna2"></tbody></table></div>
</div>
<div class="panel" id="tab-all" style="display:none">
  <div class="panel-header">
    <div class="panel-accent ca"></div>
    <span class="panel-title">GNA I + GNA II - Titulacao + PDO Term</span>
...
<div class="panel" id="tab-raw" style="display:none">
  <div class="panel-header">
    <div class="panel-accent ca"></div>
    <span class="panel-title">Cabecalho Raw</span>
...
function renderizarTabelas(registros,registrosTerm){
  ...
  renderTabela('gna1',colunas,gna1);
  renderTabela('gna2',colunas,gna2);
  renderTabelaTodos('all',colunas,registros,registrosTerm);
...
function renderTabelaTodos(id,cols,registros,registrosTerm){
...
function sortBy(id,col){
  ...
  if(id==='all')renderTabelaTodos('all',c,regs,registrosTermFiltrados);
  else renderTabela(id,c,regs,id==='term');
}
...
function filtrar(id){
  ...
  const c=id==='term'?colunasTerm:colunas;
  if(id==='all')renderTabelaTodos('all',c,subset,registrosTermFiltrados);
  else renderTabela(id,c,subset,id==='term');
}
